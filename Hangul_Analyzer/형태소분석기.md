...
print('{:<15s}'.format('Open Korean Text'), ':', ' + '.join([i + '/' + j for (i, j) in okt.pos(text)]))
print('{:<15s}'.format('Komoran'), ':', ' + '.join([i + '/' + j for (i, j) in kom.pos(text)]))
print('{:<15s}'.format('Kkma'), ':', ' + '.join([i + '/' + j for (i, j) in kkma.pos(text)]))
print('{:<15s}'.format('Mecab'), ':', ' + '.join([i + '/' + j for (i, j) in mecab.pos(text)]))
print('{:<15s}'.format('Khaiii'), ':', ' + '.join(
        [word.__str__().split('\t')[1] for word in khai3.analyze(text)]))
print('{:<15s}'.format('ETRI'), ':', ' + '.join(etri.do_lang(text).split(' ')[:-1]))
```
```
